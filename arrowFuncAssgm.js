...
        I want to click anywhere in this paragraph tag and I want to be able to change the background color to whatever is in this input: <input type="text"/>.
    ...
    <script>
        ...
        function getValueFromId(id) => document.getElementById(id).value;
        
        function setBackgroundColorById(id, color) => document.getElementById(id).style = "background-color: " + color;
        
        function mouseOverFunction(el) => el.style = "background-color: black";
    </script>
</body>
</html>
